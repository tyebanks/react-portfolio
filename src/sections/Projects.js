        ...
        return (
            <div className="hero is-light is-bold Projects-Container">
              ...
              <div className="columns is-centered">              
                ...
                <Card title= "Web Development: 2" subtitle1="Hero Game" subtitle2="JavaScript" image={<img src={project2} alt="hero-game" />}/>  
                <Card title= "Web Development: 1" subtitle1="Web News Site" subtitle2="HTML5 + CSS3" image={<img src={project3} alt="news-site" />}/>  
              </div>        
            </div>
        )
 }
