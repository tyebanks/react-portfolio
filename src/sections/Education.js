        ...
        return (
            <div className="hero is-light is-bold Education-Container">
              ...
              <div className="columns is-centered">              
                ...
                <SmallCard img={Ucci} alt="ucci logo" title="Associate Degree in Computer Science" text1="2015 - 2017" text2="University College of C.I." text3="Olympic Way" text4="Grand Cayman, Cayman Islands"/>
              </div>        
            </div>
        )
 }
